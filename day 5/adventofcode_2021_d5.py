...
def part_two():
    ...
    for i in range(len(x)):
        ...
        # Horizontal up forward (x1<x2) and (y1<y2)
        # Horizontal down forward (x1<x2) and (y1>y2)
        # Horizontal up backward (x1>x2) and (y1>y2)
        # Horizontal down backward (x1>x2) and (y1<y2)

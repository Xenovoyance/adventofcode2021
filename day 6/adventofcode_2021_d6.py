...
if __name__ == "__main__":
    ...
    print("Day 6, part 1: " + fishevolver(80) + " executed in " + (str((time.time() - start_time)* 1000)) + " ms")
    start_time = time.time()
    print("Day 6, part 2: " + fishevolver(256) + " executed in " + (str((time.time() - start_time)*1000)) + " ms")